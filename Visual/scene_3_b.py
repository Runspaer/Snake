...
def include_objs():
    ...
    # Круглая Змея
    mass.append(Snake_Control1(Snake(Physics_regular_polygon(Point(screen_size[0]//2,screen_size[1]//2),20,16,'red',3,Point(10,0),2),Point(5,5),color),Buttons(pygame.K_LEFT,pygame.K_RIGHT)))
