...
def include_objs():
    ...
    [Point(0, -10), a, b],(0,255,0),1, Point(3, 0),2),Point(screen_size[0]-80,5),Russia),
                                Snake(Physics_regular_polygon(Point(randrange(5, screen_size[0]-5, 20),
                                             randrange(5, screen_size[1]-5)),20,16,'red',0,Point(2,0),2),Point(5,5),color)],Buttons(pygame.K_LEFT,pygame.K_RIGHT)))
    ...
    mass.append(Walls_Control([],'walls_scene_1.csv'))
