...
def include_objs(screen_size:list):
    ...
    #                                                 ,'green',30,Point(2,0),5),Point(5,5)),Enum(pygame.K_LEFT,pygame.K_RIGHT)))
    ...
    mass.append(Snake_Control1(Snake(Physics_polygon(Point(screen_size[0] // 2, screen_size[1] // 2),
                                                     ...
                                                     , 'green', 10, Point(2, 0), 5), Point(5, 5)),
    ...
    # mass.append(Snake_Control1(Snake(Physics_polygon(Point(screen_size[0] // 2, screen_size[1] // 2),
    # [Point(0, -10), a, b],'green',3, Point(2, 0),5),Point(5,5)),Enum(pygame.K_LEFT,pygame.K_RIGHT)))
    size=20
    mass.append(Walls_Control(Wall(Physics_polygon(Point(300, 200),
                                                   [Point(-size, size),
                                                    ...
                                                    Point(size, -size),
                                                    Point(size, size)],
                                                   'blue', 3, Point(1, 0), 5))))  # Левая стена
